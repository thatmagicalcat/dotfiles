...
static const char *altbarcmd             = "$HOME/Apps/bar/bar.sh"; /* Alternate bar launch command */
...
static const char *triangles[]  = { "/home/thatmagicalcat/.cargo/bin/triangles", NULL };
static const char *xlens[]  = { "/home/thatmagicalcat/.cargo/bin/monocool", NULL };
static const char *screenshot[] = { "/home/thatmagicalcat/.config/dwm/scripts/screenshot.sh", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                                XK_s,      riospawn,               {.v = termcmd } },
